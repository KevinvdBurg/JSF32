...
public class KochManager {
    ...
    public void WriteToFiles(){
        ...
        application.writeMapped();
    }
    
    public void ReadFromFiles(){
        try
        {
            application.readBinaryBuffered();
            application.readBinaryNotBuffered();

            application.readTextBuffered();
            application.readTextNotBuffered();

            application.readMapped();
        } catch (Exception e)
        {
            Logger.getLogger(JSF31KochFractalFX.class.getName()).log(Level.SEVERE, null, e);
        }
